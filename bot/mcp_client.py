...
class MCPClient:
    ...
    def call(self, tool: str, args: dict) -> dict:
        ...
        try:
            ...
            if e.response.status_code in (401, 402):
                log.warning(
                    "MCP session expired (HTTP %d) — attempting renewal",
    ...
    def _renew_session(self) -> None:
        ...
        duration = (
            ...
            if self.session_duration in _VALID_DURATIONS
            else "month"
        )
    ...
    def prepare_open(
        self, leverage: float, amount: float, supply_asset: str, borrow_asset: str
    ) -> dict:
        return self.call(
            "prepare_open",
            {
    ...
    def prepare_reduce(
        self, supply_asset: str, borrow_asset: str, target_leverage: float
    ) -> dict:
        return self.call(
            "prepare_reduce",
            {
